...
def home():
    return "<h1>Hello Jayesh Patil!</h1><p>This is HTML</p>"  # This HTML displays in the browser


@app.route('/about')  
def about():
    return "I use Flask to build simple and dynamic web applications using Python."  # This text displays in the browser
